           ...
           <div class="container-fluid mt-3">
                <div class="row">
                    <div class="col-sm-8 offset-sm-2">
                        <h5 class="title-page pt-5 text-start">{{type}}</h5>
                        ...
                        <div class="card card-all-product">
                            ...
                            <div class="card-body">
                                <div class="row row-cols-1 row-cols-md-5 g-4" >
                                    <div v-for="itemProduct in products" :key="itemProduct.id">
                                        <router-link  v-bind:to="'/produk/'+itemProduct.id">
                                            <div class="col">
                                                <div class="card card-product" >
                                                    <img :src="itemProduct.photo" width="100px" height="200px" class="card-img-top" alt="cover">
                                                    <div class="card-body">
                                                        <h5 class="card-title text-start">{{itemProduct.name}}</h5>
                                                        <div class="row" v-if="itemProduct.discount>0">
                                                            <p class="card-text text-start"><s class="text-decoration-line-through">Rp.{{formatPrice(itemProduct.price)}}</s>
                                                            <span class="badge bagde-discount-product ms-1">
                                                                {{parseFloat(itemProduct.discount)}}% OFF</span></p>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-7">
                                                                <p class="card-text text-start">Rp.{{formatPrice(itemProduct.totalprice)}}</p>
                                                            </div>
                                                            <div class="col-sm-5">
                                                                <p class="card-text text-end" v-if="itemProduct.terjual!=null">{{itemProduct.terjual}} Terjual</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        methods:{
            getPagination(pageNumber){
                if(this.search==false){
                    ...
                    axios
                    .get("http://127.0.0.1:8000/api/produk/cari",{
                        params:{
